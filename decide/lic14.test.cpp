...
void test_false_instance1() {
  Points points{
      Coordinate(1, -2), Coordinate(0, 0), Coordinate(0, 0),  Coordinate(3, 4),
      Coordinate(0, 0),  Coordinate(0, 0), Coordinate(0, 0),  Coordinate(5, -6),
      Coordinate(0, 0),  Coordinate(0, 0), Coordinate(0, 0),  Coordinate(1, -2),
      Coordinate(0, 0),  Coordinate(0, 0), Coordinate(3, 4),  Coordinate(0, 0),
...
void test_false_instance2() {
  Points points{Coordinate(1, -2), Coordinate(0, 0),  Coordinate(3, 4),
...
void test_false_instance3() {
  Points points{
      ...
      Coordinate(3, 4),  Coordinate(0, 0), Coordinate(0, 0), Coordinate(5, -6),
      Coordinate(0, 0),  Coordinate(0, 0), Coordinate(0, 0), Coordinate(1, -2),
...
void test_true_instance1() {
  Points points{
      Coordinate(1, -2), Coordinate(0, 0), Coordinate(0, 0), Coordinate(0, 0),
      Coordinate(0, 0),  Coordinate(3, 4), Coordinate(0, 0), Coordinate(0, 0),
...
void test_true_instance2() {
  Points points{
      Coordinate(1, -2), Coordinate(0, 0),  Coordinate(0, 0),  Coordinate(3, 4),
      Coordinate(0, 0),  Coordinate(0, 0),  Coordinate(0, 0),  Coordinate(0, 0),
      Coordinate(0, 0),  Coordinate(5, -6), Coordinate(0, 0),  Coordinate(0, 0),
      Coordinate(0, 0),  Coordinate(1, -2), Coordinate(0, 0),  Coordinate(0, 0),
      Coordinate(3, 4),  Coordinate(0, 0),  Coordinate(0, 0),  Coordinate(0, 0),
      Coordinate(0, 0),  Coordinate(0, 0),  Coordinate(1, -6), Coordinate(0, 0),
      Coordinate(0, 0),  Coordinate(0, 0)};
...
void test_true_instance3() {
  Points points{
      Coordinate(1, -2), Coordinate(0, 0), Coordinate(3, 4), Coordinate(0, 0),
      Coordinate(0, 0),  Coordinate(0, 0), Coordinate(0, 0), Coordinate(5, -6),
...
void test_true_instance4() {
  Points points{
      Coordinate(1, -2), Coordinate(10, 2), Coordinate(2, 4),
      Coordinate(30, 4), Coordinate(5, -6), Coordinate(10, -60),
  };
