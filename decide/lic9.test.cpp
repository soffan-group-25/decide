...
void test_true_instance1() {
    Points points{Coordinate(0, 0), Coordinate(5, 5), 
                    Coordinate(1, 1), Coordinate(5, 5),
                    Coordinate(2, 0), Coordinate(5, 5),};
...
void test_true_instance2() {
    Points points{Coordinate(5, 5),Coordinate(2, 0), Coordinate(5, 5),
...
void test_false_instance3() {
    Points points{Coordinate(5, 5), Coordinate(5, 5),
